...
const Scene = ({ imageFront, imageBack, scrollYProgress }: SceneProps) => {
  ...
  const uniforms1 = useMemo(
    () => ({
      ...
      uImageResolution: {
        value: texturesLoaded
          ? new THREE.Vector2((texture1.image as any).width, (texture1.image as any).height)
          : new THREE.Vector2(1600, 1000),
      },
      uDissolve: { value: 0.0 },
  ...
  const uniforms2 = useMemo(
    () => ({
      ...
      uImageResolution: {
        value: texturesLoaded
          ? new THREE.Vector2((texture2.image as any).width, (texture2.image as any).height)
          : new THREE.Vector2(1600, 1000),
      },
      uDissolve: { value: 0.0 },
      uCenter: { value: new THREE.Vector2(0.5, 0.5) },
